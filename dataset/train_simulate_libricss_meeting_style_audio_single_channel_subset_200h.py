...
from reader import LibriSpeech_Force_Alignment_Label_Generate, \
    Single_Channel_Single_Speaker_Unsegment_Feature_Loader_Split_Mixup
...
single_speaker_3classes_without_mixup = Single_Channel_Single_Speaker_Unsegment_Feature_Loader_Split_Mixup(feature_scp,
                                                                                                           speaker_embedding_txt,
                                                                                                           label,
                                                                                                           max_utt_durance=800,
                                                                                                           frame_shift=600,
                                                                                                           mixup_rate=-1,
                                                                                                           alpha=0.5)  # silence, target speaker, inference speaker
